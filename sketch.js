...
function draw() {
  ...
  if (keyDown(LEFT_ARROW)) {
    updateHeight(-10, 0);
    balloon.addAnimation("movingLeft", balloonImage2);
  } else if (keyDown(RIGHT_ARROW)) {
    updateHeight(10, 0);
    balloon.addAnimation("movingRight", balloonImage2);
  } else if (keyDown(UP_ARROW)) {
    updateHeight(0, -10);
    balloon.addAnimation("movingUp", balloonImage2);
    balloon.scale = balloon.scale - 0.005;
  } else if (keyDown(DOWN_ARROW)) {
    updateHeight(0, +10);
    balloon.addAnimation("movingDown", balloonImage2);
    balloon.scale = balloon.scale + 0.005;
  }
